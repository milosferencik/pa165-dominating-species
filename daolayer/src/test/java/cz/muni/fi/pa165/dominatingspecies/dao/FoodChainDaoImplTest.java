...
public class FoodChainDaoImplTest extends AbstractTestNGSpringContextTests {
    ...
    public void testCreateSingleFoodChain() {
        Assertions.assertThat(foodChainDao.getAllFoodChains()).hasSize(0);
        foodChainDao.createFoodChain(foodChain1);
        Assertions.assertThat(foodChainDao.getAllFoodChains()).hasSize(1);
    }
    ...
    public void testCreateMultipleFoodChain() {
        ...
        Assertions.assertThat(foodChainDao.getAllFoodChains()).hasSize(2);
    }
    ...
    public void testGetAllFoodChainsOnEmptyDb(){
        Assertions.assertThat(foodChainDao.getAllFoodChains()).isEmpty();
    }
    ...
    public void testGetFoodChainByIdCorrectly() {
        ...
        Assertions.assertThat(foodChainDao.getFoodChain(foodChain1.getId())).isEqualToComparingFieldByFieldRecursively(foodChain1);
        Assertions.assertThat(foodChainDao.getFoodChain(foodChain2.getId())).isEqualToComparingFieldByFieldRecursively(foodChain2);
    }

    @Test
    public void testGetFoodChainByNonExistingId() {
        Assertions.assertThat(foodChainDao.getFoodChain(666L)).isNull();
    }
