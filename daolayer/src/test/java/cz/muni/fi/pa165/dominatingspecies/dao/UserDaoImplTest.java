...
public class UserDaoImplTest extends AbstractTestNGSpringContextTests{
    ...
    public void testCreateUser() {
        ...
        Assertions.assertThat(userDao.getAllUsers()).hasSize(2);
        Assertions.assertThat(userDao.getUser(u2.getId())).isEqualTo(u2);
    }
    ...
    public void testCreateUserWithNullEmail() throws Exception {
        ...
        userDao.createUser(u1);
        Assertions.assertThat(userDao.getAllUsers()).hasSize(1);
        Assertions.assertThat(userDao.getUser(u1.getId())).isEqualTo(u1);
    }
    ...
    public void testUpdateUser() {
        ...
        Assertions.assertThat(userDao.getUser(u1.getId())).isEqualToComparingFieldByField(u1);
    }
   ...
   @Test(expectedExceptions = ConstraintViolationException.class)
    ...
    public void testDeleteUser() {
        userDao.createUser(u1);
        Assertions.assertThat(userDao.getAllUsers()).isEqualTo(Collections.singletonList(u1));
        userDao.deleteUser(u1.getId());
        Assertions.assertThat(userDao.getAllUsers()).isEmpty();
    }
    ...
    public void testGetUser() {
        ...
        userDao.createUser(u2);
        Assertions.assertThat(userDao.getUser(u1.getId())).isEqualToComparingFieldByField(u1);
        Assertions.assertThat(userDao.getUser(u2.getId())).isEqualToComparingFieldByField(u2);
    }
    ...
    public void testGetUserWithNonExistentId() {
        Assertions.assertThat(userDao.getUser(5L)).isNull();
    }
    ...
    public void testGetUserByEmail() {
        userDao.createUser(u1);
        userDao.createUser(u2);
        Assertions.assertThat(userDao.getUserByEmail(u1.getEmail())).isEqualToComparingFieldByField(u1);
        Assertions.assertThat(userDao.getUserByEmail(u2.getEmail())).isEqualToComparingFieldByField(u2);
    }
