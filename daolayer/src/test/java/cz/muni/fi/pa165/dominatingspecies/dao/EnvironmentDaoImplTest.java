...
@Transactional
public class EnvironmentDaoImplTest extends AbstractTestNGSpringContextTests {
    ...
    public void testCreateEnvironment() {
        ...
        Assertions.assertThat(environmentDao.getAllEnvironments()).hasSize(1);
        environmentDao.createEnvironment(forest);
        Assertions.assertThat(environmentDao.getAllEnvironments()).hasSize(2);
        Assertions.assertThat(environmentDao.getEnvironment(dam.getId())).isEqualTo(dam);
    }
    ...
    public void testUpdateEnvironment() {
        ...
        Assertions.assertThat(environmentDao.getEnvironment(dam.getId())).isEqualToComparingFieldByField(dam);
    }
    ...
    public void testDeleteEnvironment() {
        environmentDao.createEnvironment(dam);
        Assertions.assertThat(environmentDao.getAllEnvironments()).isEqualTo(Collections.singletonList(dam));
        environmentDao.deleteEnvironment(dam.getId());
        Assertions.assertThat(environmentDao.getAllEnvironments()).isEmpty();
    }
    ...
    public void testGetAllEnvironment() {
        ...
        Assertions.assertThat(environmentDao.getAllEnvironments()).hasSize(3);
    }
    ...
    public void testGetEnvironment() {
        ...
        environmentDao.createEnvironment(marsh);
        Assertions.assertThat(environmentDao.getEnvironment(dam.getId())).isEqualToComparingFieldByField(dam);
        Assertions.assertThat(environmentDao.getEnvironment(forest.getId())).isEqualToComparingFieldByField(forest);
        Assertions.assertThat(environmentDao.getEnvironment(marsh.getId())).isEqualToComparingFieldByField(marsh);
    }
    ...
    public void testGetUserWithNonExistentId() {
        Assertions.assertThat(environmentDao.getEnvironment(4L)).isNull();
    }
