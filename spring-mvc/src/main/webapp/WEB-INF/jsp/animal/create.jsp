    ...
    <jsp:attribute name="body">
        <form:form method="post" action="${pageContext.request.contextPath}/animal/create"
            ...
            <div class="form-group ${species_error?'has-error':''}">
                <form:label path="species" cssClass="col-sm-2 control-label"><f:message
                        key="animal.species"/></form:label>
                <div class="col-sm-10">
                    <form:input path="species" cssClass="form-control"/>
                    <form:errors path="species" cssClass="help-block"/>
                </div>
            </div>
            <form:label path="environmentId" cssClass="col-sm-2 control-label"><f:message
                    key="environment"/></form:label>
            <div class="col-sm-10">
