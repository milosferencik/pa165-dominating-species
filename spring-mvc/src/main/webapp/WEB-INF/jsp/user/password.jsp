    ...
    <jsp:attribute name="body">
        <form:form method="post" action="${pageContext.request.contextPath}/user/password/${passwordChangeDto.id}"
            ...
            <div class="form-group ${newPassword_error?'has-error':''}">
                <form:label path="newPassword" cssClass="col-sm-2 control-label"><f:message key="user.new.password"/></form:label>
                <div class="col-sm-10">
            ...
            <div class="form-group ${repeatedPassword_error?'has-error':''}">
                <form:label path="repeatedPassword" cssClass="col-sm-2 control-label"><f:message key="user.repeat.password"/></form:label>
                <div class="col-sm-10">
